...
\begin{document}
	...
	\end{flushleft}
		...
		\begin{center}
			\begin{tabular}[H]{ccc}
				\fontsize{16pt}{16pt}\selectfont\textit{$first-author.name$}\fontsize{12pt}{12pt}\orcid{$first-author.orcid$} & & \fontsize{16pt}{16pt}\selectfont\textit{$second-author.name$}\fontsize{12pt}{12pt}\orcid{$second-author.orcid$}\\
				\addlinespace[0.3em]
				\fontsize{12pt}{12pt}\selectfont $first-author.affiliation$ & & \fontsize{12pt}{12pt}\selectfont $second-author.affiliation$\\
			\end{tabular}
		\end{center}
		$else$
		\begin{flushleft}
			...
			\fontsize{14pt}{14pt}\orcid{$author.orcid$} \\ %\openmaterials{$github$} 
			\vspace*{12pt}                                                                                  
